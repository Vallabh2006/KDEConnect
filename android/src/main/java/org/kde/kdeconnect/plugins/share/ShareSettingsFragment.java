...
public class ShareSettingsFragment extends PluginSettingsFragment {
    ...
    public static ShareSettingsFragment newInstance(@NonNull String pluginKey, @NonNull String deviceId, int layout) {
    ...
    public static File getDefaultDestinationDirectory() {
        ...
        File kdeConnectDir = new File(downloads, "KDEConnect");
        if (!kdeConnectDir.exists()) {
            kdeConnectDir.mkdirs();
        }
        return kdeConnectDir;
    }
