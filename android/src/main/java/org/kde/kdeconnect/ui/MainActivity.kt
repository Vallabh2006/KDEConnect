...
private const val MENU_ENTRY_FLOATING_BUTTON = 4
...
class MainActivity : AppCompatActivity(), OnSharedPreferenceChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mNavigationView.setNavigationItemSelectedListener { menuItem: MenuItem ->
            ...
            when (mCurrentMenuEntry) {
                ...
                MENU_ENTRY_FLOATING_BUTTON -> {
                    FloatingButtonHelper.showOptionsDialog(this)
                }
    ...
    private fun updateDeviceList() {
        ...
        val floatingItem = menu.add(Menu.FIRST, MENU_ENTRY_FLOATING_BUTTON, 1000, R.string.floating_action_button)
        floatingItem.setIcon(R.drawable.ic_floating_button)
        floatingItem.isCheckable = false
