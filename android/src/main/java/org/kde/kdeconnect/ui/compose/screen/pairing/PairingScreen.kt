        ...
        LazyColumn(
            ...
            if (uiState.connected.isEmpty()) {
                ...
                itemsIndexed(
                    ...
                    key = { index, connectedDevice -> "connected_${connectedDevice.id}_$index" }) { _, connectedDevice ->
                    CardContent(
            ...
            if (uiState.available.isNotEmpty()) {
                ...
                itemsIndexed(
                    ...
                    key = { index, availableDevice -> "available_${availableDevice.id}_$index" }) { _, availableDevice ->
                    CardContent(
            ...
            if (uiState.remembered.isNotEmpty()) {
                ...
                itemsIndexed(
                    ...
                    key = { index, rememberedDevice -> "remembered_${rememberedDevice.id}_$index" }) { _, rememberedDevice ->
                    CardContent(
